...
public class NPC2 {
    ...
    public void DrawHuman(float delta, boolean walk, boolean working,Texture headTexture, Texture tnt, Texture grenade,long millis) {
        ...
        float ArmRotation = (float) Math.cos(theta * 5) * 45;
        boolean wave = false;
        if (millis >= 47500) {
            wave = true;
        }
                    ...
                    GL11.glPushMatrix(); // stack 3 push
                    {
                        ...
                        GL11.glPushMatrix(); // stack 4 push
                        {
                            ...
                            if(working)
                                GL11.glRotatef(30.0f, 1.0f, 0.0f, 0.0f);
                            if(wave)
                                GL11.glRotatef(ArmRotation, 1.0f, 0.0f, 0.0f);
                            cylinder.DrawCylinder(0.15f, 0.7f, 32);
