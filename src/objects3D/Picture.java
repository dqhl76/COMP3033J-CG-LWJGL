...
public class Picture {
    ...
    Point4f[] vertices = {
            ...
            new Point4f(-1.0f, 2.0f, -1.0f, 0.0f), // 2
            new Point4f(-1.0f, 2.0f, 1.0f, 0.0f),  // 3
            new Point4f(1.0f, -1.0f, -1.0f, 0.0f), // 4
            new Point4f(1.0f, -1.0f, 1.0f, 0.0f),  // 5
            new Point4f(1.0f, 2.0f, -1.0f, 0.0f),  // 6
            new Point4f(1.0f, 2.0f, 1.0f, 0.0f)};  // 7
    ...
    public void DrawPicture(Texture texture) {
